...
{
	LoadedRenderables[RenderableName] = {RenderableToUse.AllVertexBuffers, RenderableToUse.IndexBuffer, RenderableToUse.IndexCount};
}

void AssetsManager::LoadRenderable(std::string RenderableName, USList<vde::core::gpu::Buffer*> AllVertexBuffers, vde::core::gpu::Buffer* IndexBuffer,
	int IndexCount)
{
	LoadedRenderables[RenderableName] = {AllVertexBuffers, IndexBuffer, IndexCount};
}

bool AssetsManager::GetTexture(std::string TextureName, vde::core::assets::Asset<vde::core::gpu::Image>*& OutTexture)
{
...
vde::core::assets::Asset<vde::core::gpu::Image>* AssetsManager::LoadTexture(const std::string& TextureName, const std::string& TexturePath)
{
